...
export const SEO_ROUTES = [
  ...
  { path: '/schools-and-colleges', title: 'Schools & Colleges in Pakistan | STRIDETO', description: 'This legacy directory is being retired. Use STRIDETO education guides for source-backed study information.', robots: 'noindex, follow', contentHtml: '<article><h1>Schools &amp; Colleges</h1><p>This directory is being retired while source-backed education guides are prepared.</p></article>' },
