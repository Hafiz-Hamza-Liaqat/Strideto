...
export const institutionPortalApi = {
  ...
  scholarship: (organizationId, scholarshipId) => client.get(portalPath(organizationId, `/scholarships/${encodeURIComponent(scholarshipId)}`)),
  ...
  submitScholarship: (organizationId, scholarshipId) => client.post(portalPath(organizationId, `/scholarships/${encodeURIComponent(scholarshipId)}/submit`)),
