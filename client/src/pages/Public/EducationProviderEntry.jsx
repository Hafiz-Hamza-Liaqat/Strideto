...
import { isEducationMobilityWorkspaceLaunched } from '../../config/workspaceLaunchGates';
...
export default function EducationProviderEntry() {
  const workspaceOpen = isEducationMobilityWorkspaceLaunched();
  ...
  const description =
    'A dedicated professional portal for education consultants and mobility advisors. Business Formation services use a separate professional portal.';

  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <SeoHead
        title="Education & Mobility Providers | Strideto"
        description={description}
        canonical={ROUTES.PROVIDERS_EDUCATION_MOBILITY}
      />
