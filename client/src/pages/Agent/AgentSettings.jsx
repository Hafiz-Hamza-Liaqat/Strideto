  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 space-y-2 text-sm">
        ...
        <p className="pt-2 font-medium text-gray-900 dark:text-white">Education-specific</p>
        ...
        <p className="pt-2 font-medium text-gray-900 dark:text-white">Business-specific</p>
