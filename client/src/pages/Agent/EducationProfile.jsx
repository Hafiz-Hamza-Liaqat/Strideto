    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-500 dark:text-gray-400">
          Education professional presentation is owned by this portal. Saving here does not update Business Formation profile fields.
          Specialties and destination expertise stay on this page.
        </p>
      </header>
      <AgentProfile variant="section" product="education" />
