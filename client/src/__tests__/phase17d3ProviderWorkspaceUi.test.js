...
check(files.nav.includes("label: 'My Education Services'") && files.nav.includes("label: 'My Services'") && !files.nav.includes("label: 'Trust Center'"), 'Education services and Business listings remain distinct; Trust Center is not primary nav');
