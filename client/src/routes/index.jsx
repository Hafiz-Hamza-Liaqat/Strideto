...
const EmployerApplicationDetail = lazyLoad(() => import('../pages/Employer/EmployerApplicationDetail'));
...
const AdminEducationEditorial = lazyLoad(() => import('../pages/Admin/AdminEducationEditorial'));
...
export const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'applications/:applicationId', element: <EmployerApplicationDetail /> },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'education/test-editorial', element: <AdminEducationEditorial /> },
