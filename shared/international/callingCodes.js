 ...
 *
 * Identity is the ISO country code. Calling codes are NOT unique:
 * US and CA both use `1`; several NANP territories use `1` plus a
 * distinct NDC (stored here as the full prefix, e.g. JM `1876`).
 *
 * Territories without an assigned public telephone country code are omitted
 * (AQ, BV, GS, HM, TF). Phone selectors skip those; CountrySelect still lists them.
 *
 * Client- and server-safe: pure data.
 */
export const COUNTRY_CALLING_CODES = Object.freeze({
  ...
  UA: '380', UG: '256', UM: '1', US: '1', UY: '598', UZ: '998', VA: '39',
  VC: '1784', VE: '58', VG: '1284', VI: '1340', VN: '84', VU: '678', WF: '681',
