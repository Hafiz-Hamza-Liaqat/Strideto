...
export const GBS_COMMAND_IDS = Object.freeze({
  ...
  CASE_INITIALIZE: 'gbs.case.initialize',
  CASE_START_PREPARATION: 'gbs.case.start_preparation',
  CASE_REQUEST_CUSTOMER_ACTION: 'gbs.case.request_customer_action',
  CASE_COMPLETE_CUSTOMER_ACTION: 'gbs.case.complete_customer_action',
  CASE_READY_FOR_SUBMISSION: 'gbs.case.ready_for_submission',
  CASE_CANCEL: 'gbs.case.cancel',
  CASE_UNABLE_TO_PROCEED: 'gbs.case.unable_to_proceed',
  CASE_COMPLETE_GENERIC_SERVICE: 'gbs.case.complete_generic_service',
  CASE_DOCUMENT_INITIALIZE_UPLOAD: 'gbs.case_document.initialize_upload',
  CASE_DOCUMENT_COMPLETE_UPLOAD: 'gbs.case_document.complete_upload',
  CASE_DOCUMENT_REVIEW: 'gbs.case_document.review',
  CASE_DOCUMENT_REJECT: 'gbs.case_document.reject',
  CASE_DOCUMENT_SUPERSEDE: 'gbs.case_document.supersede',
  CASE_DOCUMENT_WAIVE: 'gbs.case_document.waive',
  CASE_REQUIREMENT_FACT_UPDATE: 'gbs.case_requirement_fact.update',
