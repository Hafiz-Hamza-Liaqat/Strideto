...
/**
 * SEC-3D.4 — dormant contracts for the subject-state-only access-
 * authorization coordinator. Pure data/constants only — no Mongoose, no
 * I/O, no live route imports this yet. Authority:
 ...
 * deliberately **not** included — it is SEC-3E's own future composition
 * concern (the shared denylist check, layered alongside this coordinator
 * at the live middleware layer, §12.1) and is never producible by a
 * subject-state-only dormant coordinator. `SessionSubjectStateProvider`'s
