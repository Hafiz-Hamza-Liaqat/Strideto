...
const schema = new mongoose.Schema({
  ...
  requestedWindow: { start: { type: Date, default: null }, end: { type: Date, default: null } },
  confirmedStart: { type: Date, default: null }, durationMinutes: { type: Number, min: 15, max: 480, default: null },
