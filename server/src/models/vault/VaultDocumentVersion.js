...
const vaultDocumentVersionSchema = new mongoose.Schema(
  {
    ...
    scanJobId: { type: mongoose.Schema.Types.ObjectId, ref: 'GbsDocumentScanJob', default: null },
    storageClass: { type: String, default: null },
    quarantineBucket: { type: String, default: null },
    cleanBucket: { type: String, default: null },
    encryption: { type: mongoose.Schema.Types.Mixed, default: null },
    classification: { type: String, default: null },
    retentionClass: { type: String, default: null },
