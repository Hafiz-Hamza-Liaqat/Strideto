...
import { marketplacePaymentsRouter } from './marketplacePayments.js';
import { institutionPortalRouter } from './institutionPortal.js';
import { copilotRouter } from './copilot.js';
import { budgetRouter } from './budget.js';
import { skillClaimsRouter } from './skillClaims.js';
import { privacyRouter } from './privacy.js';
import { announcementsRouter } from './announcements.js';

export { healthRouter, contactRouter, feedbackRouter, institutionsRouter, supportRouter, userInboxRouter, jobsRouter, scholarshipsRouter, admissionsRouter, blogsRouter, foreignStudiesRouter, authRouter, oauthRouter, adminRouter, trendingRouter, newsletterRouter, notificationsRouter, monetizationRouter, usersRouter, v1Router, examsRouter, internshipsRouter, chatbotRouter, webinarsRouter, intlScholarshipsRouter, badgesRouter, seoRouter, resumesRouter, employerRouter, publicProfilesRouter, careerArticlesRouter, resumeTemplatesRouter, cmsRouter, formsRouter, dynamicContentRouter, searchRouter, analyticsRouter, talentRouter, opportunityApplicationsRouter, timelineRouter, documentsRouter, credentialsRouter, careerDashboardRouter, migrationRouter, scoringRouter, assessmentsRouter, employerIntelligenceRouter, organizationVerificationRouter, testsRouter, correctionsRouter, personalizationRouter, actionEngineRouter, vaultRouter, agentRouter, consultationRouter, caseRouter, professionalTrustRouter, commerceRouter, marketplacePaymentsRouter, institutionPortalRouter, copilotRouter, budgetRouter, skillClaimsRouter, privacyRouter, announcementsRouter };
